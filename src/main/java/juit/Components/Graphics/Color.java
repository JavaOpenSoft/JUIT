...
public class Color {
    ...
    public final int[] Maroon = {0,0,0};
    public final int[] Olive = {0,0,0};
    public final int[] Green = {0,0,0};
    public final int[] Purple = {0,0,0};
    public final int[] Teal = {0,0,0};
    public final int[] Navy = {0,0,0};
    public final int[] Gold = {0,0,0};
